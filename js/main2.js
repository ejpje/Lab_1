...
function Popup(properties, attribute, layer, radius){
  ...
  this.prescFires = this.properties[attribute];
  this.content = "<p><b>State:</b> " + this.properties.State + "</p><p><b>Number of prescribed fires in " + this.year + ":</b> " + this.prescFires + "</p>";
...
function updateLegend(map, attribute){
  ...
  var year = attribute.split("_")[1];
  var content = "Number of prescribed fires in " + year;
